...
namespace BloodSwordRogue::Character
{
    ...
    BloodSwordRogue::StringMap<Character::Status> StatusMapping = {
    ...
    BloodSwordRogue::IntegerMap<Character::Status> Duration = {
    ...
    BloodSwordRogue::UnorderedMap<Character::Status, Character::Status> CounterEffects = {
    ...
    {
        return BloodSwordRogue::Find(Character::StatusMapping, status);
    }
