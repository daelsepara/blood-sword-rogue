...
namespace BloodSwordRogue::Character
{
    ...
    BloodSwordRogue::ConstStrings<Character::ControlType> ControlTypeMapping = {
    ...
    {
        return BloodSwordRogue::Find(Character::ControlTypeMapping, control_type);
    }
    ...
    BloodSwordRogue::StringMap<Character::Class> ClassMapping = {
    ...
    {
        return BloodSwordRogue::Find(Character::ClassMapping, character_class);
    }
