...
namespace BloodSwordRogue::Generate
{
    ...
    void Skills(Character::Base &character)
    {
        ...
        case Character::Class::TRICKSTER:
            ...
            character.Skills.push_back(Skills::Map("DODGING"));

            character.Skills.push_back(Skills::Map("ARCHERY"));

            break;

        case Character::Class::SAGE:

            character.Skills.push_back(Skills::Map("HEALING"));

            character.Skills.push_back(Skills::Map("QUARTERSTAFF"));

            character.Skills.push_back(Skills::Map("ESP"));

            character.Skills.push_back(Skills::Map("PARANORMAL SIGHT"));

            character.Skills.push_back(Skills::Map("LEVITATION"));

            character.Skills.push_back(Skills::Map("EXORCISM"));

            character.Skills.push_back(Skills::Map("ARCHERY"));

            character.SkillImmunity.push_back(Skills::Map("PARALYZING TOUCH"));

            break;

        case Character::Class::ENCHANTER:

            character.Skills.push_back(Skills::Map("SPELLS"));
    ...
    {
        if (!character.HasSkill(Skills::Map("SPELLS")) || character.Class != Character::Class::ENCHANTER)
        {
            return;
        }
    ...
    void WarriorItems(Character::Base &warrior)
    {
        if (warrior.Rank <= 8)
        {
            warrior.AddItem(Item::Base("SWORD", Item::MapType("SWORD"), {Item::MapProperty("WEAPON"), Item::MapProperty("PRIMARY"), Item::MapProperty("EQUIPPED")}, Item::NONE, 1, 1, Asset::Map("SWORD")));

            warrior.AddItem(Item::Base("CHAINMAIL", Item::MapType("CHAINMAIL"), {{Attribute::Type::ARMOUR, 3}}, {Item::MapProperty("ARMOUR"), Item::MapProperty("EQUIPPED")}, 1, 1, Asset::Map("CHAINMAIL")));
        }
    }
    ...
    void TricksterItems(Character::Base &trickster)
    {
        if (trickster.Rank <= 8)
        {
            trickster.AddItem(Item::Base("SWORD", Item::MapType("SWORD"), {Item::MapProperty("WEAPON"), Item::MapProperty("PRIMARY"), Item::MapProperty("EQUIPPED")}, Item::NONE, 1, 1, Asset::Map("SWORD")));

            trickster.AddItem(Item::Base("BOW", Item::MapType("BOW"), {Item::MapProperty("WEAPON"), Item::MapProperty("RANGED"), Item::MapProperty("EQUIPPED")}, Item::NONE, 1, 1, Asset::Map("ARCHERY")));

            trickster.AddItem(Item::Base("QUIVER", Item::MapType("QUIVER"), {Item::MapProperty("CONTAINER"), Item::MapProperty("CANNOT DROP"), Item::MapProperty("CANNOT TRADE")}, Item::MapType("ARROW"), 6, Item::Unlimited, Asset::Map("QUIVER")));

            trickster.AddItem(Item::Base("LEATHER ARMOUR", Item::MapType("LEATHER ARMOUR"), {{Attribute::Type::ARMOUR, 2}}, {Item::MapProperty("ARMOUR"), Item::MapProperty("EQUIPPED")}, 1, 1, Asset::Map("LEATHER ARMOUR")));
        }
    }
    ...
    void SageItems(Character::Base &sage)
    {
        if (sage.Rank <= 8)
        {
            sage.AddItem(Item::Base("QUARTERSTAFF", Item::MapType("QUARTERSTAFF"), {Item::MapProperty("WEAPON"), Item::MapProperty("PRIMARY"), Item::MapProperty("EQUIPPED")}, Item::NONE, 1, 1, Asset::Map("QUARTERSTAFF")));

            sage.AddItem(Item::Base("BOW", Item::MapType("BOW"), {Item::MapProperty("WEAPON"), Item::MapProperty("RANGED"), Item::MapProperty("EQUIPPED")}, Item::NONE, 1, 1, Asset::Map("ARCHERY")));

            sage.AddItem(Item::Base("QUIVER", Item::MapType("QUIVER"), {Item::MapProperty("CONTAINER"), Item::MapProperty("CANNOT DROP"), Item::MapProperty("CANNOT TRADE")}, Item::MapType("ARROW"), 6, Item::Unlimited, Asset::Map("QUIVER")));

            sage.AddItem(Item::Base("RINGMAIL", Item::MapType("RINGMAIL"), {{Attribute::Type::ARMOUR, 2}}, {Item::MapProperty("ARMOUR"), Item::MapProperty("EQUIPPED")}, 1, 1, Asset::Map("RINGMAIL")));
        }
    }
    ...
    void Money(Character::Base &character)
    {
        ...
        character.AddItem(Item::Base("MONEY POUCH", Item::MapType("POUCH"), {Item::MapProperty("CONTAINER"), Item::MapProperty("CANNOT DROP"), Item::MapProperty("CANNOT TRADE")}, Item::MapType("GOLD"), character.Rank * 5, Item::Unlimited, Asset::Map("MONEY")));
    }
    ...
    void Combat(Character::Base &character)
    {
        ...
        case Character::Class::TRICKSTER:
            ...
            character.Shoot = Skills::Map("ARCHERY");
    ...
    void Target(Character::Base &character)
    {
        ...
        case Character::Class::WARRIOR:
            ...
            character.Target = Target::Map("WARRIOR");

            break;

        case Character::Class::TRICKSTER:

            character.Target = Target::Map("TRICKSTER");

            break;

        case Character::Class::SAGE:

            character.Target = Target::Map("SAGE");

            break;

        case Character::Class::ENCHANTER:

            character.Target = Target::Map("ENCHANTER");
    ...
    {
        return NPC(name, Skills::NONE, Skills::NONE, skills, attributes, moves, asset);
    }
