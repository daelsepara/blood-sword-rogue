...
namespace BloodSwordRogue::Spells
{
    // spell type
    enum class Type
    {
    ...
    template <typename T>
    using Mapped = BloodSwordRogue::UnorderedMap<Spells::Type, T>;
    ...
    BloodSwordRogue::StringMap<Spells::Type> TypeMapping = {
    ...
    BloodSwordRogue::ConstStrings<Spells::Type> AssetNames = {
        {Spells::Type::VOLCANO_SPRAY, "VOLCANO SPRAY"},
        {Spells::Type::NIGHTHOWL, "NIGHTHOWL"},
        {Spells::Type::WHITE_FIRE, "WHITE FIRE"},
        {Spells::Type::SWORDTHRUST, "SWORDTHRUST"},
    ...
    BloodSwordRogue::StringMap<Spells::Class> ClassMapping = {
    ...
    BloodSwordRogue::IntegerMap<Spells::Type> Difficulty = {
        {Spells::Type::NONE, 2},
    ...
    BloodSwordRogue::IntegerMap<Spells::Type> DifficultyModifier = {
        {Spells::Type::NONE, 0},
    ...
    BloodSwordRogue::IntegerMap<Spells::Type> Damage = {
        {Spells::Type::NONE, 0},
    ...
    BloodSwordRogue::IntegerMap<Spells::Type> AlternateDamage = {
        {Spells::Type::NONE, 0},
        {Spells::Type::VOLCANO_SPRAY, 1},
        {Spells::Type::NIGHTHOWL, 0},
        {Spells::Type::WHITE_FIRE, 2},
    ...
    BloodSwordRogue::IntegerMap<Spells::Type> DamageModifier = {
        {Spells::Type::NONE, 0},
        {Spells::Type::VOLCANO_SPRAY, 0},
        {Spells::Type::NIGHTHOWL, 0},
        {Spells::Type::WHITE_FIRE, 2},
    ...
    {
        return BloodSwordRogue::Find(Spells::TypeMapping, spell);
    }
    ...
    {
        return BloodSwordRogue::Find(Spells::ClassMapping, spell_class);
    }
    ...
    {
        return SafeCast(list.size()) > 0 && BloodSwordRogue::Has(list, spell);
    }
